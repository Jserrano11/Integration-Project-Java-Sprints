...
public class Integration {
	...
	public static void main(String[] args) {
		...
		System.out.println("This is an array. Please start by typing in the amount of numbers you would like in the array, then"
				+ " type each number followed by the enter key to find the sum and minimum of the array.");
		...
		System.out.println("This here is a 2-D version of an array instead of a 1-D model.");
